    ...
    return (
        <div className="mb-3">
            <div className="flex flex-col gap-3 xl:flex-row xl:items-end xl:justify-between">
                <div className="min-w-0">
                    {/* <p className="text-[10px] font-semibold uppercase tracking-wider text-[#8a8d91]">
                        Performance
                    </p> */}
                    <h2 className="mt-0.5 truncate text-base font-semibold tracking-tight text-[#1c1e21]">
                        {selectedAd.name || "Unnamed ad"}
                    </h2>
                </div>

                <div className="rounded-lg border border-[#dce3ec] bg-white p-2">
                    <div className="flex flex-col gap-2 sm:flex-row sm:items-end">
                        ...
                        <div className="hidden h-8 items-center px-1 text-xs text-[#8a8d91] sm:flex">
                            →
                        </div>
